...
import "../../stylesheets/create-report.scss";
import axios from "axios";
import Cookies from "universal-cookie";
const cookies = new Cookies();

const CreateReportDam = (props) => {
  const {
    register,
    handleSubmit,
    control,
  ...
  return (
    <div className="create-report-container container-fluid">
      <div className="row">
        <div className="col-12">
          ...
          >
            <div className="section-container report-flex-property">
              <TextField
...
export default CreateReportDam;
